...
public class GuiItemsData {
	...
	private NbtData nbt;
	private int slot;
	private GuiItemsData_fill mimeSlots;
	private List<String> leftActions;
	private List<String> rightAction;

	public GuiItemsData(String id, String clickSound, String material, int amount, boolean glow, String name, List<String> lore, String texture, NbtData nbt, int slot, GuiItemsData_fill mimeSlots, List<String> leftAction, List<String> rightAction) {
		this.setId(id);
